...
path = New_base_path+"\\images\\machine\\factory"
...
def visualization(data):
    ...
    static_image_path = os.path.join(os.getcwd(), path, 'factory_analysis.png')
    plt.savefig(static_image_path)
    print("/api/rev/images/reviveimagemachine/factory/factory_analysis.png")
    plt.close()
#############################################
visualization(data)
